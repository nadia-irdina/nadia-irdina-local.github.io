...
How to answer?: 
- comparing variable: *"us_viewers"* against *"original_air_date."* 
- comparing variable: *"directed_by"* against *"us_viewers"* 
- comparing variable: *"written_by"* against *"us_viewers"* 
- comparing variable: count of *"season"* against *"us_viewers"*

*Click on the \["Insights"\] page to see results.*
